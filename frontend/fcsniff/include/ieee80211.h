...
#define	IEEE802_11_QOS_CTL_LEN		2
...
struct ieee80211_frame {
	u_int8_t	i_fc[IEEE802_11_FC_LEN];
	u_int8_t	i_dur[IEEE802_11_DUR_LEN];
	u_int8_t	i_addr1[IEEE80211_ADDR_LEN];
	u_int8_t	i_addr2[IEEE80211_ADDR_LEN];
	u_int8_t	i_addr3[IEEE80211_ADDR_LEN];
	u_int8_t	i_seq[IEEE802_11_SEQ_LEN];
...
struct ieee80211_qosframe {
	...
	u_int8_t	i_addr3[IEEE80211_ADDR_LEN];
	u_int8_t	i_seq[IEEE802_11_SEQ_LEN];
	u_int8_t	i_qos[IEEE802_11_QOS_CTL_LEN];
	/* possibly followed by addr4[IEEE80211_ADDR_LEN]; */
	/* see below */
} __packed;
...
struct ieee80211_frame_pspoll {
	u_int8_t	i_fc[IEEE802_11_FC_LEN];
	u_int8_t	i_aid[IEEE802_11_DUR_LEN];
...
struct ieee80211_frame_cfend {		/* NB: also CF-End+CF-Ack */
	u_int8_t	i_fc[IEEE802_11_FC_LEN];
	u_int8_t	i_dur[IEEE802_11_DUR_LEN];	/* should be zero */
	u_int8_t	i_ra[IEEE80211_ADDR_LEN];
	u_int8_t	i_bssid[IEEE80211_ADDR_LEN];
	/* FCS */
} __packed;
