...
import org.mortbay.cometd.ext.StatisticsExtension;
...
public class CometdDemo
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        comet.setInitParameter("timeout","30000");
        comet.setInitParameter("interval","0");
        comet.setInitParameter("maxInterval","15000");
        comet.setInitParameter("maxLazyLatency","2000");
        comet.setInitParameter("multiFrameInterval","2500");
