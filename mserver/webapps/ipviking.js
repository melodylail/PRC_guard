...
(function(window) {
    ...
    */
                    ...
                    var cols = rows.selectAll("td")
                        .data(function(d) {
                            return [
                                ...
                                spanWrap(d.city, ["location", "overflow"]),
                                d.md5,
                                spanWrap(d.city2,["location", "overflow", "numeric"]),
                                spanWrap(d.service,["service", "overflow"]),
    ...
    function queryAllReports(){
        $.ajax({
            type: "GET",
            url: "http://192.168.245.147/demo.bin", 
    ...
    function handleResult(data){
        ...
        /*{
            ...
            jQuery.each(jsonObj, function(index, row) {
                pauser.push(row);
    ...
    function reportWorker() {
        ...
        setInterval(function () { queryAllReports(); }, 3 * 1000);
    ...
    setInterval(function () { queryAllReports(); }, 1 * 1000);
